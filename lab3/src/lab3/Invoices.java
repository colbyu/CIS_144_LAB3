...
public class Invoices {
   ...
   //determine the shipper
    System.out.println("enter shipping method (A for Fedex shipping ($5.00), B for UPS shipping ($10.00), C for DHL shippimg ($7.20), or D for free USPS shipping)");
    ...
    do { //Check and correct erronious entry:
         System.out.println("Invalid shipper choice!");
         System.out.println("enter shipping method (A for Fedex, B for UPS, C for DHL, or D for USPS)");
    ...
    System.out.println("enter shipping method (A for expedited shipping ($5.00), B for one day shipping ($10.00), C for two day ($7.20), or D for free standard ground shipping)");
    shipMethod = sc.next().charAt(0);
    ...
    System.out.println("and it eill be shipped by " + carrier);
